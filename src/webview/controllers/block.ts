...
import { blockMaterialsPath, getPrivateBlockMaterialsPath } from '../../utils/vscodeEnv'
...
export const createBlock = (
  ...
  fs.outputFileSync(path.join(blockPath, 'config', 'commandPrompt.ejs'), message.data.commandPrompt)
  fs.outputFileSync(path.join(blockPath, 'config', 'viewPrompt.ejs'), message.data.viewPrompt)
  fs.outputFileSync(
